...
AGENT_LLM="gpt-4o"
DB_PATH="./remembr_v2_seq4.db"
KEYFRAMES_DIR="./data/v2/keyframes"
DATA_DIR="./data"
CODA_DIR="./coda_data"
OUT_DIR="./analysis_v2_seq4_gpt4o"
...
tar -czf remembr_v2_seq4_gpt4o.tar.gz \
    $OUT_DIR/ \
    $DB_PATH \
    $KEYFRAMES_DIR/ \
    ...
    2>&1 | tail -3
echo "    remembr_v2_seq4_gpt4o.tar.gz: $(du -sh remembr_v2_seq4_gpt4o.tar.gz | cut -f1)"
