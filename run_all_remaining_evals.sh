...
# ── Non-random: seq4 clipvlm + clip (t95 before t90) ─────────────────────────
run_eval "seq4_clipvlm_t90" 4 "$DB/seq4_clipvlm_t90.db" "$RES/seq4_clipvlm_t90"
run_eval "seq4_clip_t95"    4 "$DB/seq4_clip_t95.db"     "$RES/seq4_clip_t95"
run_eval "seq4_clip_t90"    4 "$DB/seq4_clip_t90.db"     "$RES/seq4_clip_t90"

# ── Random baselines last (t95 before t90) ────────────────────────────────────
...
echo "[$(date)] ALL EVALS COMPLETE" | tee -a "$LOG_DIR/run.log"
